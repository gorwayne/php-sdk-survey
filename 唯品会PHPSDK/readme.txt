...
try {
	...
	//$ctx->setAppURL("http://gw.vipapis.com/");//正式环境
...
ii.对于原因不明的失败，请通过开放平台的支持中心搜索解决方案或提交问题进行报障：http://vop.vip.com/support/index

b.网络环境不稳定或超时？

i.如果是正式环境，请确认调用参数AppUrl是否为http://gw.vipapis.com
ii.若业务参数包含分页数据，请按照API在线文档（http://vop.vip.com/apicenter/index）的建议大小设置每页数据大小，一般建议每页数据在100以内
iii.其他疑难问题，请通过开放平台的支持中心提交问题进行报障：http://vop.vip.com/support/index

c.sdk如何升级？

可到开放平台下载sdk最新版本，：http://vop.vip.com/doccenter/viewdoc/20
