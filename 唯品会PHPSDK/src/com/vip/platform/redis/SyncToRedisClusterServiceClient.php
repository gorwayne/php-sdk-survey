...
class SyncToRedisClusterServiceClient{
	...
	public static function getService(){
		...
		if (! SyncToRedisClusterServiceClient::$isRegis){
			
			SyncToRedisClusterServiceClient::regis ();
			SyncToRedisClusterServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SyncToRedisClusterServiceClient::$DEFAULT_PROXY_IP;
		$port = SyncToRedisClusterServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\platform\redis\SyncToRedisClusterServiceHelper();
	}
