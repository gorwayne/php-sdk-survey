...
class DeveloperResourceServiceClient{
	...
	public static function getService(){
		...
		if (! DeveloperResourceServiceClient::$isRegis){
			
			DeveloperResourceServiceClient::regis ();
			DeveloperResourceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = DeveloperResourceServiceClient::$DEFAULT_PROXY_IP;
		$port = DeveloperResourceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\platform\user\DeveloperResourceServiceHelper();
	}
