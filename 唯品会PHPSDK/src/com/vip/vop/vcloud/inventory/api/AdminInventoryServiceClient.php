...
class AdminInventoryServiceClient{
	...
	public static function getService(){
		...
		if (! AdminInventoryServiceClient::$isRegis){
			
			AdminInventoryServiceClient::regis ();
			AdminInventoryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = AdminInventoryServiceClient::$DEFAULT_PROXY_IP;
		$port = AdminInventoryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\vcloud\inventory\api\AdminInventoryServiceHelper();
	}
