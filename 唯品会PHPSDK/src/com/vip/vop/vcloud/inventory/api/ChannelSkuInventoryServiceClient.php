...
class ChannelSkuInventoryServiceClient{
	...
	public static function getService(){
		...
		if (! ChannelSkuInventoryServiceClient::$isRegis){
			
			ChannelSkuInventoryServiceClient::regis ();
			ChannelSkuInventoryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ChannelSkuInventoryServiceClient::$DEFAULT_PROXY_IP;
		$port = ChannelSkuInventoryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\vcloud\inventory\api\ChannelSkuInventoryServiceHelper();
	}
