...
class DieselProductSelfServiceClient{
	...
	public static function getService(){
		...
		if (! DieselProductSelfServiceClient::$isRegis){
			
			DieselProductSelfServiceClient::regis ();
			DieselProductSelfServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = DieselProductSelfServiceClient::$DEFAULT_PROXY_IP;
		$port = DieselProductSelfServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\vcloud\product\DieselProductSelfServiceHelper();
	}
