...
class JitOxoOrderInnerServiceClient{
	...
	public static function getService(){
		...
		if (! JitOxoOrderInnerServiceClient::$isRegis){
			
			JitOxoOrderInnerServiceClient::regis ();
			JitOxoOrderInnerServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = JitOxoOrderInnerServiceClient::$DEFAULT_PROXY_IP;
		$port = JitOxoOrderInnerServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\jitoxo\JitOxoOrderInnerServiceHelper();
	}
