...
class QueryOxoOrderVo {
	...
	public $endTime = null;
	public $status = null;
	public $confirmStoreStates = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['confirmStoreStates'])){
				
				$this->confirmStoreStates = $vals['confirmStoreStates'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("confirmStoreStates" == $schemeField){
				
				$needSkip = false;
				
				$this->confirmStoreStates = array();
				$_size1 = 0;
				$input->readListBegin();
				while(true){
					...
					try{
						...
						$this->confirmStoreStates[$_size1++] = $elem1;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		if($this->confirmStoreStates !== null) {
			
			$xfer += $output->writeFieldBegin('confirmStoreStates');
			
			if (!is_array($this->confirmStoreStates)){
				
				throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
			}
			
			$output->writeListBegin();
			foreach ($this->confirmStoreStates as $iter0){
