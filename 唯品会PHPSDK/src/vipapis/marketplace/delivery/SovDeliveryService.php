...
interface SovDeliveryServiceIf{
	...
	public function getOrderList(\vipapis\marketplace\delivery\GetOrderListRequest $request);
...
class _SovDeliveryServiceClient extends \Osp\Base\OspStub implements \vipapis\marketplace\delivery\SovDeliveryServiceIf{
	...
	public function getCarrierList(){
		...
		$this->send_getCarrierList();
		return $this->recv_getCarrierList();
	}
	
	public function send_getCarrierList(){
		
		$this->initInvocation("getCarrierList");
		$args = new \vipapis\marketplace\delivery\SovDeliveryService_getCarrierList_args();
	...
	public function recv_getCarrierList(){
		...
		$result = new \vipapis\marketplace\delivery\SovDeliveryService_getCarrierList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getOrderList(\vipapis\marketplace\delivery\GetOrderListRequest $request){
		...
		$this->send_getOrderList( $request);
		return $this->recv_getOrderList();
	}
	
	public function send_getOrderList(\vipapis\marketplace\delivery\GetOrderListRequest $request){
		
		$this->initInvocation("getOrderList");
		$args = new \vipapis\marketplace\delivery\SovDeliveryService_getOrderList_args();
	...
	public function recv_getOrderList(){
		...
		$result = new \vipapis\marketplace\delivery\SovDeliveryService_getOrderList_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class SovDeliveryService_getCarrierList_args {
...
class SovDeliveryService_getOrderList_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \vipapis\marketplace\delivery\GetOrderListRequest();
			$this->request->read($input);
...
class SovDeliveryService_getCarrierList_result {
...
class SovDeliveryService_getOrderList_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\marketplace\delivery\GetOrderListResponse();
			$this->success->read($input);
