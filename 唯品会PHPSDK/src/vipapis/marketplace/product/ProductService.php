...
interface ProductServiceIf{
	...
	public function getProducts(\vipapis\marketplace\product\QueryProductRequest $request);
...
class _ProductServiceClient extends \Osp\Base\OspStub implements \vipapis\marketplace\product\ProductServiceIf{
	...
	public function send_getProducts(\vipapis\marketplace\product\QueryProductRequest $request){
...
class ProductService_getProducts_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \vipapis\marketplace\product\QueryProductRequest();
...
class ProductService_getProducts_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\marketplace\product\QueryProductsResponse();
			$this->success->read($input);
