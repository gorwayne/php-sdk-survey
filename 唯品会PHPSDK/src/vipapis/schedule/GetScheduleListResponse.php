...
class GetScheduleListResponse {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['schedules'])){
				
				$this->schedules = $vals['schedules'];
			}
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('schedules');
		...
		foreach ($this->schedules as $iter0){
