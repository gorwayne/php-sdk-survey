...
class ScheduleServiceClient{
	...
	public static function getService(){
		...
		if (! ScheduleServiceClient::$isRegis){
			
			ScheduleServiceClient::regis ();
			ScheduleServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ScheduleServiceClient::$DEFAULT_PROXY_IP;
		$port = ScheduleServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\schedule\ScheduleServiceHelper();
	}
